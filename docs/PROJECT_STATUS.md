...
El usuario confirmó en producción (2026-09-21) la verificación física del **transporte de la notificación de prueba**: **TEST - Mérito Radar** apareció físicamente en la **pantalla bloqueada** y al tocarla **abrió correctamente Mérito Radar**; los 3 concursos seguidos permanecieron intactos y no se generó ninguna alerta CNSC ficticia. Siguen NOT VERIFIED: generación real de notificación con app cerrada/teléfono bloqueado, recorrido worker → cambio CNSC real → outbox → notificación, deep link real hacia concurso/evento y Doze/restricciones OEM. Detalle en STATUS.
